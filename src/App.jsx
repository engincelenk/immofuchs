...
import { MARKET_RATES, GREST, BL_N, BL_O, MIET_P, SAN_ENERGIE, SAN_NORMEN, SAN_TIERS, SAN_SRC_KEYS, LAND_F, LAND_BONUS_FQ, LAND_BONUS_CAP } from "./data.js";
...
function Tip({text,label}){
  ...
  useEffect(()=>{if(s&&ref.current&&!isMobile){const r=ref.current.getBoundingClientRect();if(r.left<120)setPos("left");else if(r.right>window.innerWidth-120)setPos("right");else setPos("center")}},[s]);
  ...
  return <span ref={ref} style={{position:"relative",display:"inline-block",marginLeft:4}}>
    ...
    {!isMobile&&s&&<div style={{position:"absolute",bottom:"calc(100% + 6px)",...st,width:220,padding:"8px 10px",background:"#1a1a1a",color:"#fff",fontSize:11,lineHeight:1.4,borderRadius:6,zIndex:100,pointerEvents:"none",whiteSpace:"normal",fontWeight:400}}>{text}</div>}
        ...
        <div className="calc-cards">
          {[
            {tab:"haupt",featured:true,title:l.fullTitle,badge:l.fullBadge,desc:l.fullDesc,feats:[l.fullF1,l.fullF2,l.fullF3,l.fullF4,l.fullF5,l.fullF6],cta:l.fullCta,
             ...
             illus:<svg viewBox="0 0 280 130" style={{width:"100%",height:"100%"}} preserveAspectRatio="xMidYMid meet"><defs><linearGradient id="g1" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#e8600a" stopOpacity=".15"/><stop offset="100%" stopColor="#e8600a" stopOpacity=".4"/></linearGradient></defs><polygon points="40,90 70,55 100,90" fill="url(#g1)" opacity=".6"/><path d="M40 90 L40 105 L100 105 L100 90 Z" fill="#e8600a" opacity=".25"/><polyline points="110,100 140,88 168,73 198,57 228,40 268,24" stroke="#e8600a" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round"/><circle cx="268" cy="24" r="4" fill="#e8600a"/><text x="212" y="18" fontSize="11" fontWeight="700" fill="#c44d00" fontFamily="DM Sans">+4,1%</text><line x1="10" y1="105" x2="275" y2="105" stroke="#e8600a" strokeWidth="1" opacity=".2"/></svg>},
            {tab:"kredit",title:l.finTitle,badge:l.finBadge,desc:l.finDesc,feats:[l.finF1,l.finF2,l.finF3,l.finF4,l.finF5,l.finF6],cta:l.finCta,
             ...
             illus:<svg viewBox="0 0 280 130" style={{width:"100%",height:"100%"}} preserveAspectRatio="xMidYMid meet"><g opacity=".75">{[80,95,82,68,55,42,35,28].map((h,i)=><rect key={i} x={105+i*22} y={110-h} width="14" height={h} rx="2" fill={i<3?"#5fa97d":"#7dbe97"}/>)}</g><rect x="8" y="38" width="95" height="52" rx="6" fill="#fff" opacity=".7" stroke="#5fa97d" strokeWidth="1"/><text x="28" y="57" fontSize="9" fontWeight="700" fill="#3a7a55" fontFamily="DM Sans" letterSpacing=".5">RATE</text><text x="28" y="78" fontSize="16" fontWeight="700" fill="#2d6043" fontFamily="DM Sans">1.154 €</text><line x1="0" y1="110" x2="280" y2="110" stroke="#5fa97d" strokeWidth="1" opacity=".3"/></svg>},
            {tab:"miete",title:l.rentTitle,badge:l.rentBadge,desc:l.rentDesc,feats:[l.rentF1,l.rentF2,l.rentF3,l.rentF4,l.rentF5,l.rentF6],cta:l.rentCta,
             ...
             illus:<svg viewBox="0 0 280 130" style={{width:"100%",height:"100%"}} preserveAspectRatio="xMidYMid meet"><text x="40" y="95" fontSize="68" fontWeight="800" fill="#e8600a" opacity=".12" fontFamily="DM Sans" letterSpacing="-2">§558</text><line x1="15" y1="80" x2="268" y2="80" stroke="#c44d00" strokeWidth="1.5" opacity=".5"/>{[15,95,178,268].map((x,i)=><g key={i}><circle cx={x} cy="80" r={i===2?7:5} fill={i===2?"#e8600a":"#fff"} stroke="#c44d00" strokeWidth="1.5"/></g>)}<rect x="98" y="20" width="90" height="22" rx="11" fill="#e8600a"/><text x="110" y="35" fontSize="11" fontWeight="700" fill="#fff" fontFamily="DM Sans">+15% max. ↑</text></svg>},
            {tab:"sanier",title:l.sanTitle,badge:l.sanBadge,desc:l.sanDesc,feats:[l.sanF1,l.sanF2,l.sanF3,l.sanF4,l.sanF5,l.sanF6],cta:l.sanCta,
             ...
             illus:<svg viewBox="0 0 280 130" style={{width:"100%",height:"100%"}} preserveAspectRatio="xMidYMid meet"><polygon points="10,80 42,52 74,80 74,108 10,108" fill="#7a9bb8" opacity=".4"/>{[{l:"A+",c:"#3aa754",w:52},{l:"A",c:"#5fb86f",w:44},{l:"B",c:"#a3cf6a",w:36},{l:"C",c:"#e8c14f",w:28},{l:"D",c:"#e89545",w:22},{l:"E",c:"#d9613a",w:16}].map((cl,i)=><g key={i}><rect x="130" y={30+i*14} width="22" height="11" rx="1.5" fill={cl.c}/><rect x="152" y={30+i*14} width={cl.w} height="11" rx="1.5" fill={cl.c} opacity=".55"/><text x="136" y={40+i*14} fontSize="8" fontWeight="700" fill="#fff" fontFamily="DM Sans">{cl.l}</text></g>)}<text x="218" y="60" fontSize="18" fontWeight="800" fill="#1d6af5" fontFamily="DM Sans">−60%</text><text x="230" y="76" fontSize="10" fill="#5a7a9a" fontFamily="DM Sans">CO₂</text></svg>},
...
export default function App(){const[tab,setTab]=useState("haupt");const[lang,setLang]=useState("de");
  ...
  const t=T[lang];
  const tabs=[{id:"haupt",l:t.haupt,ic:IC.haupt},{id:"kredit",l:t.kredit,ic:IC.kredit},{id:"miete",l:t.miete,ic:IC.miete},{id:"sanier",l:t.sanier,ic:IC.sanier},{id:"steuer6",l:t.steuer6,ic:IC.steuer6},{id:"saved",l:t.merkliste,ic:IC.saved}];
  ...
  return <Ctx.Provider value={{d:data,set,t,lang,zinsen,tip:k=>(TIPS[lang]||TIPS.de)[k],savedList,saveObj,delObj,loadObj,setTabExt:(id)=>{setTab(id);setTimeout(()=>window.scrollTo({top:0,behavior:"smooth"}),50);}}}>
    ...
    <div className="shell" dir="ltr">
      ...
      <div className="content">
        <Statusleiste/>
        {tab==="haupt"&&<Haupt/>}{tab==="kredit"&&<Kredit/>}{tab==="miete"&&<Miete/>}{tab==="sanier"&&<Sanier/>}{tab==="steuer6"&&<SteuerTrick/>}{tab==="saved"&&<Merkliste/>}
