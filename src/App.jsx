...
import { MARKET_RATES, PFANDBRIEF, GREST, BL_N, BL_O, MIET_P, SAN_ENERGIE, SAN_NORMEN, SAN_TIERS, SAN_SRC_KEYS, LAND_F, LAND_BONUS_FQ, LAND_BONUS_CAP } from "./data.js";
...
// ═══ ACCORDION SECTION ═══
function AccordionSection({question,hint,color,children,defaultOpen=false}){
  ...
  return <div><VT view={view} setView={setView}/><div className="split">
    ...
    <div className={`res-pane ${view==="result"?"act":""}`}>
      {!R?<div style={{textAlign:"center",padding:"60px 20px",color:"var(--ch)"}}><div style={{fontSize:40,opacity:.12}}>🏠</div></div>:<>
        <div style={{display:"flex",alignItems:"center",gap:8,margin:"0 0 12px",paddingBottom:10,borderBottom:"2px solid var(--ca)"}}>
        ...
        {/* ═══ SELBSTTRÄGER-CHECK ═══ */}
        {(()=>{
          const cfOCol=R.cf2OhneSt>0?"green":R.cf2OhneSt>=-100?"yellow":"red";
          const cfMCol=R.cf2MitSt>0?"green":R.cf2MitSt>=-100?"yellow":"red";
          ...
          const selfIntro=R.cf2OhneSt>0?t.sec2GreenCF:R.cf2OhneSt>=-100?t.sec2YellowCF:t.sec2RedCF;
          return <AccordionSection question={t.selfQ} hint={t.selfHint} color={selfHex}>
        ...
        {(()=>{
          const brCol=R.bR>=5?"green":R.bR>=4?"yellow":"red";
          const nrCol=R.nR>=3.5?"green":R.nR>=2.5?"yellow":"red";
          ...
          return <AccordionSection question={t.sec2Q} hint={t.sec2Hint} color={ampelHex}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"repeat(2,minmax(0,1fr))",gap:10,marginBottom:10}}>
              <AmpelKPI label={t.cfOhneSt} value={fmtE(R.cf2OhneSt)}
                ...
                status={R.cf2OhneSt>0?"✓ "+t.cfOGreen:R.cf2OhneSt>=-100?"~ "+t.cfOYellow:"⚠ "+t.cfORed}
                tip={R.cf2OhneSt>0?t.cfOGreenTip:R.cf2OhneSt>=-100?t.cfOYellowTip:t.cfORedTip}/>
              <AmpelKPI label={t.cfMitSt} value={fmtE(R.cf2MitSt)}
                color={cfMCol}
                statusLabel={cfMCol==="green"?t.badgeGut:cfMCol==="yellow"?t.badgeOkay:t.badgeKrit}
                status={R.cf2MitSt>0?"✓ "+t.cfMGreen:R.cf2MitSt>=-100?"~ "+t.cfMYellow:"⚠ "+t.cfMRed}
                tip={R.cf2MitSt>0?t.cfMGreenTip:R.cf2MitSt>=-100?t.cfMYellowTip:t.cfMRedTip}/>
            </div>
        ...
        {(()=>{
          const belCol=R.bel<70?"green":R.bel<85?"yellow":"red";
          const lzCol=!isFinite(R.lz)||R.lz>35?"red":R.lz>25?"yellow":"green";
        ...
        <AccordionSection question={t.sec5Q} hint={t.sec5Hint}>
