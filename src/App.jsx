        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(240px,1fr))",gap:18}}>
          {[
            ...
            {tab:"kredit",title:l.finTitle,badge:l.finBadge,desc:l.finDesc,feats:[l.finF1,l.finF2,l.finF3,l.finF4,l.finF5,l.finF6],cta:l.finCta,
             ...
             illus:<svg viewBox="0 0 280 130" style={{width:"100%",height:"100%"}} preserveAspectRatio="xMidYMid slice"><g opacity=".75">{[80,95,82,68,55,42,35,28].map((h,i)=><rect key={i} x={105+i*22} y={110-h} width="14" height={h} rx="2" fill={i<3?"#5fa97d":"#7dbe97"}/>)}</g><rect x="8" y="38" width="95" height="52" rx="6" fill="#fff" opacity=".7" stroke="#5fa97d" strokeWidth="1"/><text x="28" y="57" fontSize="9" fontWeight="700" fill="#3a7a55" fontFamily="DM Sans" letterSpacing=".5">RATE</text><text x="28" y="78" fontSize="16" fontWeight="700" fill="#2d6043" fontFamily="DM Sans">1.154 €</text><line x1="0" y1="110" x2="280" y2="110" stroke="#5fa97d" strokeWidth="1" opacity=".3"/></svg>},
            {tab:"miete",title:l.rentTitle,badge:l.rentBadge,desc:l.rentDesc,feats:[l.rentF1,l.rentF2,l.rentF3,l.rentF4,l.rentF5,l.rentF6],cta:l.rentCta,
             ...
             illus:<svg viewBox="0 0 280 130" style={{width:"100%",height:"100%"}} preserveAspectRatio="xMidYMid slice"><text x="40" y="95" fontSize="68" fontWeight="800" fill="#e8600a" opacity=".12" fontFamily="DM Sans" letterSpacing="-2">§558</text><line x1="15" y1="80" x2="268" y2="80" stroke="#c44d00" strokeWidth="1.5" opacity=".5"/>{[15,95,178,268].map((x,i)=><g key={i}><circle cx={x} cy="80" r={i===2?7:5} fill={i===2?"#e8600a":"#fff"} stroke="#c44d00" strokeWidth="1.5"/></g>)}<rect x="98" y="20" width="90" height="22" rx="11" fill="#e8600a"/><text x="110" y="35" fontSize="11" fontWeight="700" fill="#fff" fontFamily="DM Sans">+15% max. ↑</text></svg>},
