  ...
  return (
    ...
    >
      <div style={{ fontSize: 12, fontWeight: 700, color: "var(--ct)", marginBottom: 2 }}>
        {t.chartQuellenTitle || "Woher kommt die Rendite?"}
      </div>
      ...
      <div style={{ position: "relative", overflowX: "auto" }}>
        <svg
          ...
          role="img"
          aria-label={t.chartQuellenTitle}
        >
      ...
      {hover !== null &&
        ...
        (() => {
          const v = vals[hover];
          const total = v.tilg + v.wert + v.st + v.cf;
          return (
            <div style={{ fontSize: 10.5, color: "var(--ct)", marginTop: 8, lineHeight: 1.6 }}>
              J{v.j}: {t.tilgung} {fmtE(v.tilg)} · {t.wertP} {fmtE(v.wert)} · {t.steuerErs}{" "}
              {fmtE(v.st)} · {t.cashflow} {fmtE(v.cf)} → <b>{fmtE(total)}</b>
            </div>
          );
        })()}
      <div
