...
export const ASSISTANT_T = {
  de: {
    ...
    hintFoerderantrag: "Achtung: Förderantrag muss VOR die Beauftragung. Klick für Details.",
    hintIdle: "Klick mich — ich erklär dir dein Ergebnis.",
    hintVergleich: "Welches Objekt ist besser? Klick hier, ich vergleiche.",
    landingBubble: "Hi, ich bin Finn. Klick mich, ich helf dir beim Einstieg.",
  ...
  en: {
    ...
    hintFoerderantrag: "Heads up: apply for funding BEFORE commissioning the work. Tap for details.",
    hintIdle: "Tap me — I'll explain your result.",
    hintVergleich: "Which property is better? Tap here, I'll compare.",
    landingBubble: "Hi, I'm Finn. Tap me, I'll get you started.",
  ...
  tr: {
    ...
    hintFoerderantrag: "Dikkat: Teşvik başvurusu işi vermeden ÖNCE yapılmalı. Detay için tıkla.",
    hintIdle: "Tıkla — sonucunu açıklayayım.",
    hintVergleich: "Hangi mülk daha iyi? Tıkla, karşılaştırayım.",
    landingBubble: "Merhaba, ben Finn. Tıkla, başlamana yardım edeyim.",
  ...
  zh: {
    ...
    hintFoerderantrag: "注意：必须在委托施工前申请补贴。点击查看详情。",
    hintIdle: "点我——我来解释你的结果。",
    hintVergleich: "哪套更划算？点这里，我来对比。",
    landingBubble: "你好，我是 Finn。点我，我帮你开始。",
  ...
  hi: {
    ...
    hintFoerderantrag: "ध्यान दें: काम सौंपने से पहले सब्सिडी के लिए आवेदन करें। विवरण के लिए क्लिक करें।",
    hintIdle: "मुझे क्लिक करें — मैं आपका नतीजा समझाता हूँ।",
    hintVergleich: "कौन-सी संपत्ति बेहतर है? यहाँ क्लिक करें, मैं तुलना करता हूँ।",
    landingBubble: "नमस्ते, मैं Finn हूँ। मुझे क्लिक करें, मैं शुरू करने में मदद करूँगा।",
