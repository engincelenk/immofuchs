...
export const ASSISTANT_T = {
  de: {
    ...
    suggestedMaklerFragen: "Welche Fragen sollte ich dem Makler zu diesem Objekt stellen?",
  ...
  en: {
    ...
    suggestedMaklerFragen: "What questions should I ask the agent about this property?",
  ...
  tr: {
    ...
    suggestedMaklerFragen: "Bu mülkle ilgili emlakçıya hangi soruları sormalıyım?",
  ...
  zh: {
    ...
    suggestedMaklerFragen: "关于这套房产,我应该向中介问哪些问题?",
  ...
  hi: {
    ...
    suggestedMaklerFragen: "इस संपत्ति के बारे में मुझे एजेंट से क्या सवाल पूछने चाहिए?",
