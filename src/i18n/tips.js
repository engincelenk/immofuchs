...
export const TIPS = {
  de: {
    ...
    anschlussZins:
      "Optional: dein erwarteter Zinssatz für die Zeit NACH Ende der Zinsbindung. Leer gelassen rechnet der Rechner mit dem heutigen Zinssatz unverändert weiter. Die Rate bleibt gleich, nur die Aufteilung zwischen Zins und Tilgung verschiebt sich.",
