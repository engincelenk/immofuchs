...
export const TIPS={
  de:{
    ...
    altAnlage:"Angenommene jährliche Rendite einer Alternativanlage (z.B. ETF/Aktienmarkt) zum Vergleich mit der Immobilie. Historischer Richtwert: 6-7% p.a.",
  ...
  en:{
    ...
    altAnlage:"Assumed annual return of an alternative investment (e.g. ETF/stock market) to compare against the property. Historical benchmark: 6-7% p.a.",
  ...
  tr:{
    ...
    altAnlage:"Mülkle karşılaştırmak için varsayılan alternatif yatırım (örn. ETF/borsa) yıllık getirisi. Tarihsel referans: yıllık %6-7.",
  ...
  hi:{
    ...
    altAnlage:"संपत्ति से तुलना हेतु मान लिया गया वैकल्पिक निवेश (जैसे ETF/शेयर बाज़ार) का वार्षिक प्रतिफल। ऐतिहासिक संदर्भ: वार्षिक 6-7%।",
